	...
	results: [
		{
			...
			relatedNotes: [
				{
					...
					id: 82884270,
					freeText:
						'Yeast GRS1 is homologous to human GARS1, and has been used to study Charcot-Marie-Tooth disease type 2D and severe infantile-onset spinal muscular atrophy',
					noteType: {
						internal: false,
						obsolete: false,
						id: 7662728,
			...
			diseaseAnnotationObject: {
				...
				definitionUrls: ['url:http://en.wikipedia.org/wiki/Situs_ambiguus'],
			...
			evidenceCodes: [
				{
					...
					definitionUrls: ['GO:TAS', 'ECO:RCT'],
					subsets: ['agr_eco_terms'],
					synonyms: [
						{
							internal: false,
							obsolete: false,
			...
			inferredAllele: {
				...
				inCollection: {
					...
					name: 'B2B/CvDC',
					definition:
						'The National Heart, Lung, and Blood Institute (NHLBI) Bench to Bassinet (B2B) Program of translational research in pediatric cardiovascular disease',
				},
				isExtinct: false,
				alleleSymbol: {
					internal: false,
