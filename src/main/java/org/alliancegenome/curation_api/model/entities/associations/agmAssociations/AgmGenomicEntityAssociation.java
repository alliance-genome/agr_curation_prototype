...
@Schema(name = "AgmGenomicEntityAssociation", description = "POJO representing an association between an AGM and a genomic entity")
public class AgmGenomicEntityAssociation extends EvidenceAssociation {
