...
public enum ChromosomeAccessionEnum {
	...
	MGI_1("1", "RefSeq:NC_000067.6", "GRCm39"),
	MGI_2("2", "RefSeq:NC_000068.7", "GRCm39"),
	MGI_3("3", "RefSeq:NC_000069.6", "GRCm39"),
	MGI_4("4", "RefSeq:NC_000070.6", "GRCm39"),
	MGI_5("5", "RefSeq:NC_000071.6", "GRCm39"),
	MGI_6("6", "RefSeq:NC_000072.6", "GRCm39"),
	MGI_7("7", "RefSeq:NC_000073.6", "GRCm39"),
	MGI_8("8", "RefSeq:NC_000074.6", "GRCm39"),
	MGI_9("9", "RefSeq:NC_000075.6", "GRCm39"),
	MGI_10("10", "RefSeq:NC_000076.6", "GRCm39"),
	MGI_11("11", "RefSeq:NC_000077.6", "GRCm39"),
	MGI_12("12", "RefSeq:NC_000078.6", "GRCm39"),
	MGI_13("13", "RefSeq:NC_000079.6", "GRCm39"),
	MGI_14("14", "RefSeq:NC_000080.6", "GRCm39"),
	MGI_15("15", "RefSeq:NC_000081.6", "GRCm39"),
	MGI_16("16", "RefSeq:NC_000082.6", "GRCm39"),
	MGI_17("17", "RefSeq:NC_000083.6", "GRCm39"),
	MGI_18("18", "RefSeq:NC_000084.6", "GRCm39"),
	MGI_19("19", "RefSeq:NC_000085.6", "GRCm39"),
	MGI_X("X", "RefSeq:NC_000086.7", "GRCm39"),
	MGI_Y("Y", "RefSeq:NC_000087.7", "GRCm39"),
	MGI_MT("MT", "RefSeq:NC_005089.1", "GRCm39"),
	RGD_1("1", "RefSeq:NC_005100.4", "mRatBN7.2"),
	RGD_2("2", "RefSeq:NC_005101.4", "mRatBN7.2"),
	RGD_3("3", "RefSeq:NC_005102.4", "mRatBN7.2"),
	RGD_4("4", "RefSeq:NC_005103.4", "mRatBN7.2"),
	RGD_5("5", "RefSeq:NC_005104.4", "mRatBN7.2"),
	RGD_6("6", "RefSeq:NC_005105.4", "mRatBN7.2"),
	RGD_7("7", "RefSeq:NC_005106.4", "mRatBN7.2"),
	RGD_8("8", "RefSeq:NC_005107.4", "mRatBN7.2"),
	RGD_9("9", "RefSeq:NC_005108.4", "mRatBN7.2"),
	RGD_10("10", "RefSeq:NC_005109.4", "mRatBN7.2"),
	RGD_11("11", "RefSeq:NC_005110.4", "mRatBN7.2"),
	RGD_12("12", "RefSeq:NC_005111.4", "mRatBN7.2"),
	RGD_13("13", "RefSeq:NC_005112.4", "mRatBN7.2"),
	RGD_14("14", "RefSeq:NC_005113.4", "mRatBN7.2"),
	RGD_15("15", "RefSeq:NC_005114.4", "mRatBN7.2"),
	RGD_16("16", "RefSeq:NC_005115.4", "mRatBN7.2"),
	RGD_17("17", "RefSeq:NC_005116.4", "mRatBN7.2"),
	RGD_18("18", "RefSeq:NC_005117.4", "mRatBN7.2"),
	RGD_19("19", "RefSeq:NC_005118.4", "mRatBN7.2"),
	RGD_20("20", "RefSeq:NC_005119.4", "mRatBN7.2"),
	RGD_X("X", "RefSeq:NC_005120.4", "mRatBN7.2"),
	RGD_Y("Y", "RefSeq:NC_024475.1", "mRatBN7.2"),
	...
	private ChromosomeAccessionEnum(String chromosomeName, String accession, String assemblyName) {
		this.chromosomeName = chromosomeName;
		this.accession = accession;
		this.assemblyIdentifier = assemblyName;
	}

	public static ChromosomeAccessionEnum getChromosomeAccessionEnum(String chromosomeAccession) {
		if (chromosomeAccession == null) {
			return null;
		}
		for (ChromosomeAccessionEnum chromosome : values()) {
			if (chromosomeAccession.equals(chromosome.accession)) {
				return chromosome;
			}
		}
		return null;
	...
	public static String getChromosomeAccession(String chromosomeName, String assemblyIdentifier) {
